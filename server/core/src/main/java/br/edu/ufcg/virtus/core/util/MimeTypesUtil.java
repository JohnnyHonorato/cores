...
public class MimeTypesUtil {
	...
	public static final String MIME_APPLICATION_MSWORDX = "application/vnd.openxmlformats-officedocument.wordprocessingml.document";
	...
	static {
		mimeTypeMapping = new HashMap<String, String>(200) {
...

			{
				...
				put1("docx", MIME_APPLICATION_MSWORDX);
	...
	public static String getExt(String value) {
